...
[assembly: MelonInfo(typeof(TldHacks.ModMain), "TldHacks", "2.7.19", "user")]
...
public class ModMain : MelonMod
{
    ...
    // v2.7.19 —— 单调递增帧计数器,用 modulo 把 7 个 tick 摊到不同帧,消除 90 帧 1 次的集中大 spike
    ...
    public override void OnInitializeMelon()
    {
        ...
        try
        {
            ...
            Log.Msg($"TldHacks v2.7.19 loaded — menu hotkey = {Settings.MenuHotkey}, items = {ItemDatabase.All.Count}");
        }
    ...
    public override void OnUpdate()
    {
        try
        {
            ...
            // Time scale —— v2.7.19:默认 1.0 时不写回,避免覆盖第三方时间加速 mod
            ...
            // v2.7.19 FPS 修:所有 tick 按 frame modulo 摊到不同帧
