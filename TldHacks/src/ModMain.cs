...
[assembly: MelonInfo(typeof(TldHacks.ModMain), "TldHacks", "2.7.3", "user")]
...
public class ModMain : MelonMod
{
    ...
    public override void OnInitializeMelon()
    {
        ...
        try
        {
            ...
            Log.Msg($"TldHacks v2.7.3 loaded — menu hotkey = {Settings.MenuHotkey}, items = {ItemDatabase.All.Count}");
        }
