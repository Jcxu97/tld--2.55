...
自动拾取列表从 ~130 行扩到 **363 行**(2026-04-27 加了 68 件衣服 + 8 件杂项),新增类别:
...
- **杂项补漏(2026-04-27 再追 8 件)**:`SodaGrape`、`DogFood`、`Hacksaw`、`CanOpener`、`RecycledCan`、`HeavyBandage`、`MagnifyingLens`、`CandyBar`。
