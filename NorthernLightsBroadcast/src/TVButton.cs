...
public class TVButton : MonoBehaviour
{
	...
	public void Awake()
	{
		...
		if (!isSetup)
		{
			...
			((Renderer)meshRenderer).material.SetColor("_EmissionColor", (Color)emissionColorOff);
	...
	public void Glow(bool enabled)
	{
		...
		if (enabled)
		{
			...
			((Renderer)meshRenderer).material.SetColor("_EmissionColor", (Color)emissionColorOn);
			isGlowing = true;
		}
		else
		{
