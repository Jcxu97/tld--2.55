...
namespace PastimeReading
{
	...
	internal static class Settings
	{
		...
		public static void OnLoad()
		{
			...
			((ModSettingsBase)options).AddToModSettings("Pastime Reading Settings");
		}
	}
	internal class ReadSettings : JsonModSettings
	{
		...
		[Choice(new string[] { "Justified", "Left", "Right", "Centered" })]
		...
		[Choice(new string[] { "New", "Classic" })]
		public int bookTilt;

		[Section("Customization")]
		[Name("Book texture")]
		[Description("Book appearance. \n\nYou can modify textures yourself. They should be here ...Mods/pastimeReading/textures/")]
		[Choice(new string[] { "Simple Red", "Simple Blue", "Simple White", "Simple Yellow", "Detailed Grey", "Detailed Yellow", "Detailed Black" })]
